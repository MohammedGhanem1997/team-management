...
export class CreateAllEntities0051700000006000 implements MigrationInterface {
  name = "CreateAllEntities0051700000006000";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createForeignKey('player_skill_improvements', new TableForeignKey({
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    if (impTable) {
      ...
      if (fk) await queryRunner.dropForeignKey('player_skill_improvements', fk);
    ...
    if (playerTable) {
      ...
      if (fk) await queryRunner.dropForeignKey('player', fk);
